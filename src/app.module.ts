  ...
  imports: [TypeOrmModule.forRoot(config),
    ...
    SalaryModule,
     CompaniesModule,
      ...
      LocaltionModule,
      LeveljobsModule,
      TypejobModule, ProjectCandidateModule, SkillsCandidateModule, EducationCandidateModule, ExperienceCandidateModule, CertificateCandidateModule, TypecompanyModule, AuthModule, MailerModule], 
  controllers: [],
  providers: [],
})
